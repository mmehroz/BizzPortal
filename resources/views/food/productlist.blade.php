...
<style>
    ...
    .check-head {
        font-size: 25px; color: #121212; text-transform: capitalize;
    }
            ...
            <div class="row">
                <div class="col-12">
                    <nav class="navbar navbar-expand-lg fixed-top">
                        <a class="navbar-brand" href="{{URL::to('restaurantlist')}}"><img src="{{URL::to('public/assets/img/logo_white_header.svg')}}" alt="" width="250px"></a>
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-10">
                    <div class="row">
                        <div class="col-8">
                            <div style="box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0;padding: 10px;">
                            <div class="row">
                             
                                <div class="col-lg-8">
                                    <div class="bg1" style="background: url('{{URL::to('public/restaurant/')}}/{{$datares->restaurant_picture}}'); background-size: cover; height: 350px;border-radius:5px">
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <h5 class="ed pt-3" style="text-align: center; margin-top: 65px; font-weight: bold; font-size: 40px; color: #121212;">Exclusive Deals</h5>
                                </div>
                            </div>
