                ...
                <!-- <div class="header-left">
                 ...
                 <div class="header-left">
                    <a href="{{URL('maindashboard')}}" class="logo">
						<img src="{!! asset('public/assets/img/bizz_white_icon.svg') !!}"  width="100%" height="5" alt="">
						<img src="{!! asset('public/assets/img/logo_white_header.svg') !!}" width="200px"  style="display:none" alt="">
					</a>
					<script>
        $(document).ready(function() {
            $("#toggle_btn").click(function() {
				...
				<a id="backbutton" title="Click to go back">
					<i class="fa fa-arrow-left" style="font-size:18px; color: #ffffff;margin-top: 22px; cursor: pointer;"></i>
				</a>
				@endif
				<!-- /Logo -->
				@if(session()->get('role') != 4)
...
<footer class="text-center" >
					© COPYRIGHT <?php echo(date('Y'));?> Bizz World Communications ALL RIGHTS RESERVED.
			</footer>
    </body>
</html>