				...
				<div class="container">
					<!-- <div class="account-box"> -->
						<div class="account-wrapper">
							...
							Interview Invitation | Bizz World Communication 
							</div>
							<!-- end preheader -->
							          ...
							          <tr>
							            <td align="left" bgcolor="#ffffff" style="padding: 24px; padding-top:20px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
							              <p style="margin: 0; color: #000;">
							            	...
							            	Don’t miss this opportunity as <b>Bizz World Communication</b> gives candidates a platform to further discuss their background and expand on key aspects of their work experience that make them a great fit for the position and help find their dream job.<br>
