...
<body class="body"style="padding:0 !important; margin:0 !important; display:block !important; min-width:100% !important; width:100% !important; background:#9A192E; -webkit-text-size-adjust:none;">
    <div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
        Interview Invitation | Bizz World Communications
    </div>
 ...
 <p style="margin: 0; color: #000;">
											...
											<!-- <tr>
												<td class="text-left pb20"style="color:#5d5c5c; font-family:'Raleway', Arial,sans-serif; font-size:14px; line-height:22px; text-align:left; padding-bottom:20px;">
                                                    <multiline>We want to thank you for taking the time to submit your job application to Bizz World Communications. We appreciate your interest in our organization and the effort you put into completing the application process.
                                                    <br>
                                                    <br>
