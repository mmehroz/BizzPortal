							        ...
							        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
							          ...
							          <tr>
							            <td align="left" bgcolor="#ffffff" style="padding: 24px;  padding-bottom:0px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
							              <p style="margin: 0; color: #000;">Thank you for your application for the position of <b>{{$datas['candidatedata']->jobapplicant_postionapppliedform }}</b> at Bizz World Communications. I would like to invite you to a face-to-face interview at our office.
