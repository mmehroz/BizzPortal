...
<head>
    ...
    <link
        ...
        rel="stylesheet" />
    <!--<![endif]-->
    <title>Invitation to Interview - Bizz World Communications</title>
    <!--[if gte mso 9]>
...
<body class="body"
    style="padding:0 !important; margin:0 !important; display:block !important; min-width:100% !important; width:100% !important; background:#9A192E; -webkit-text-size-adjust:none;">
    <div class="preheader"
        style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
        Invitation to Interview - Bizz World Communications
    </div>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td bgcolor="#ffffff" class="p30-15 img-center"
                                        ...
                                        <a href="https://www.bizzworldcommunications.com/" target="_blank"><img
                                                src="https://bizzworldcommunications.com/bwc.png" width="146" height="57"
                                                border="0" alt="" /></a></td>
                                </tr>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td class="text-left pb20"
                                                    ...
                                                    <multiline>We are pleased to inform you that your application for the <b>{{$datas['candidatedata']->jobapplicant_postionapppliedform }}.</b> position at Bizz World Communications has been reviewed, and we are impressed with your qualifications and experience. As a result, we would like to invite you for an interview with our team.<br><br>
                                                        ...
                                                        <br><br>
                                                        During the interview, you will have the opportunity to meet with members of our hiring team and discuss your skills, experience, and qualifications in further detail. You will also have the opportunity to learn more about Bizz World Communications and the role that you have applied for.
                                                        <br><br>
                                                        ...
                                                        <br><br>
                                                        Thank you for considering Bizz World Communications as your potential employer, and we look forward to hearing back from you soon.
                                                        <br>
                                                        ...
                                                        <strong style="color:#000">Best Regards,
                                                            ...
                                                            Team Recruitment
                                                            <br>
                                                            Bizz World Communications</strong>
                                                    </multiline>
                                                </td>
                                            </tr>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td class="text-footer2 p30-15"
                                        ...
                                        <multiline style="color: #fff;">PLOT #2, STREET #5, Block 6 Gulshan-e-Iqbal, Karachi, Pakistan <br />
                                            <p style="color: #fff;">© <?php echo(date('Y'))?> Bizz World Communications . All Right Reserved.</p>
                                        </multiline>
                                    </td>
                                </tr>
                            </table>
