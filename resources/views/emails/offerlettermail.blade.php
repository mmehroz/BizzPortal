...
<head>
    ...
    <link
        ...
        rel="stylesheet" />
    <!--<![endif]-->
    <title>Offer Letter - Bizz World Communications</title>
    <!--[if gte mso 9]>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td class="text-left pb20"
                                                    ...
                                                    <multiline>  We are pleased to inform you that based on your qualifications, experience, and interview performance, Bizz World Communications has decided to offer you the position of <strong>{{$datas['candidatedata']->evu_cantechdesgdept}}</strong>.
                                                        <br><br>
                                                        <!-- <p>{{$datas['candidatedata']->evu_cansalary}}</p><br><br> -->
                                                        We believe that your skills and experience align with our organization's requirements, and we are confident that you will be a valuable addition to our team. Enclosed, you will find your appointment letter that outlines the terms and conditions of your employment with Bizz World Communications.
                                                        <br><br>
                                                        ...
                                                        <br><br>
                                                        Congratulations once again, and we wish you all the best for a successful career at Bizz World Communications.
                                                        <br><br>
