...
goals of my employees remain the same; to serve our clients. 
			...
			<p>
			The purpose of this Policy Manual is to make the policies and procedures of BIZZ WORLD COMMUNICATIONS as clear and useful as possible. It is made to provide trainers from different angles with direction and guidance in connection with provision, procedures, and reports that should be uniform throughout the organization.
			</p>
			<p>
			This policy manual is an official directive of BIZZ WORLD COMMUNICATIONS and as part of the general responsibility it will also serve as an official document for training directorate and the respective coordinators which will be assigned by different departments within BIZZ WORLD COMMUNICATIONS.
			</p>
			<p>
			...
			<ul>
				...
				<li>Recruit the best qualified professionals and to maintain a pool of human resources according to the manpower requirement and planning of BIZZ WORLD COMMUNICATIONS. This is to assist in new member recruitment that policy and procedures clearly point the interested people what are you looking for.</li>
			...
			<p>
				Development is an ongoing process and it is so for BIZZ WORLD COMMUNICATIONS too. The attempt of putting together this Policy Manual is part of this initiative keeping in perspective the size that we have grown to. It is important that we are all in tandem and on a common page.
				</p>
				<p>
			...
			<p>
			Bizz World Communications is committed to conduct business with the highest integrity and in compliance with applicable laws. The Standards of Business Conduct embodies the fundamental principles that govern our ethical and legal obligations at Bizz World Communications. It describes, summarizes and supplements policies, some of which have been in place at Bizz World Communications for years.
			</p>
			<p>
			...
			<p>
			All Bizz World Communications employees are expected to read and understand this Code of Business Conduct and Ethics. Violating the Standard of <b> Business Conduct may result in very serious consequences for the Company and you.</b>
			</p>
		</div>
		<div class="col-md-12 mt-3">
		<h4 class="ml-md-5 mb-2">1.2 Standard of Business Conduct by the Company:</h4>
		<p>
		Standard of Business Conduct and Ethics is intended to comply with the applicable requirements, as needed, and to promote Bizz World Communication’s standards of business conduct. All Bizz World Communications employees are expected to read and understand this Standard of Business Conduct and Ethics, uphold these standards in day-to-day activities, comply with all applicable policies and procedures, and ensure that all agents and contractors are aware of, understand and adhere to these standards.
		</p>
		<p>
		...
		<ul>
			...
			<li>Full, fair, accurate, timely and understandable disclosure in reports and documents that Bizz World Communications files with any concerned regulatory authority.</li>
			...
			<li>Since the principles described in this Standard of Business Conduct and Ethics are general in nature, you should also be aware of all applicable Bizz World Communications policies and procedures for more specific instruction, and contact the Human Resources Department or Training and Organizational Development Department if you have any questions.</li>
		</ul>
		<p>
		Ethical business conduct is critical to our business. As an employee, your responsibility is to respect and adhere to the practices in this document. Many of these practices reflect legal or regulatory requirements. Violations of these laws and regulations can create significant liability for you, Bizz World Communications, its directors, HOD’s, and other employees.
		</p>
		<p>
		Violations of law, this Standard of Business Conduct and Ethics or other company policies or procedures by Bizz world Communications employees can lead to disciplinary action, up to and including termination. Part of your job and ethical responsibility is to help enforce this Standard of Business Conduct and Ethics
		</p>
		<p>
...
Reprisal, threats, retribution or retaliation against any person who has in good faith reported a violation or a suspected violation of law, this Standard of Business Conduct and Ethics or other Bizz World Communications policies, or against any person who is assisting in any investigation or process with respect to such a violation, is prohibited.
...
In all cases, if you are unsure about the appropriateness of an event or action, please seek assistance in interpreting the requirements of these practices.
	...
	<ul>
		...
		<p>
		Welcome to the Bizz World Communications Recruitment & Appointment section. This section provides much of the information about types of employment/appointments, opportunities and the way in which Bizz World Communications undertakes the recruitment and selection of talent.</p>

<p> You will find at your ‘fingertips’ a wide variety of policies, procedural instructions, pro forma/templates and guidance notes on a wide variety of recruitment related topics that will both educate those involved in recruitment activities and assist in facilitating the acquisition of staff, in the Bizz World Communications way!.

A commitment to acquiring high performing, quality candidates who match the requirements of the Bizz World Communications, the work area and the job;
		</p>
		<ul>
			<li>
			Conducting recruitment and related practices, with due regard for the principles of Bizz World Communications that remain free from any form of favoritism, nepotism or biases.
			</li>
			<li>
		...
		<ul>
			...
			<li>
			All successful appointees to the Bizz World Communications will sign a contract of employment prior to commencement.
			</li>
			<li>
			In exceptional circumstances, Bizz World Communications reserves the right to appoint by invitation a candidate who demonstrates the ability to meet or exceed the required capabilities. This must be approved in accordance with the HR Delegations.
			</li>
			<li>
			Bizz World Communications reserves the right not to make an appointment if there are no suitable applicants, or if circumstances change making it inappropriate to offer a contract.
			</li>
		</ul>
		</div>
		<div class="col-md-12">
...
<p>
The documents will be submitted by the new inductee to HR before he/she will join Bizz World Communications (Even on probation or trial basis). It should include following things;
</p>
<ul>
	<li>
...
<div class="col-md-12">
	...
	<p>
	New inductees have to sign the policies before he/she start training or join the floor to make environment more secure and free. Bizz World Communications wants every employee to feel good and secure while working in the office environment.
	</p>
...
<div class="col-md-12">
	...
	<p>
	Offer letters will be given to new employee once they submit all the necessary documents to HR on the very first day of joining. Bizz World Communications wants to make it sure that every employee should feel the environment in a more professional way on a very first step he enters into the office.
	</p>
</div>
<div class="col-md-12">
	...
	<p>
	It provides a broad range of information to help staff understand the Bizz World Communications context and to settle in to their new roles, working as part of the Bizz World Communications community.
	</p>
</div>
<div class="col-md-12">
...
<div class="col-md-12">
	...
	<p>
	All the employees will receive the final confirmation letter from HR, once their complete their probationary period with Bizz World Communications.
	</p>
</div>
<div class="col-md-12">
	<h4 class="ml-md-5 mb-3">
	...
	<p>
	In rear cases Bizz World Communications hire few employees on contract base for the limited tenure. All those employees cannot resign until their tenure is over. They could be on free-lance or on full shifts. But only Directors can decide and confirm about their full time and part time employment.</p>
</div>
<div class="col-md-12">
<h3 class="page-title text-center mb-4">3. TRAINING AND DEVELOPMENT</h3>
<p>
The purpose of this training introduction is to make the training and procedures of Bizz World Communications as clear and useful as possible. It is made to provide employees from different angles with direction and guidance in connection with provision, procedures, and reports that should be uniform throughout the organization.
</p>
<p>
This training is an official instruction for employees and as part of the general responsibility it will also serve as an official document for training directorate and the respective coordinators which will be assigned by different departments within Bizz World Communications.
</p>
</div>
<div class="col-md-12">
	...
	<p>
	Pakistan is nowadays found in the state of continuous changes and highly demanding trained and active work force. Bizz World Communications in this regard is contributing its share in the process of producing skilled employees and strived to bring and lead the development agenda through capacity building. Unless and otherwise we have a well-structured training policy which can enrich to the community at large, we will not be able to fight poverty and inequality. It is due to this fact that this policy necessitates to come in to being. Also it is a must rather than a choice to find alternative schemes for Bizz World Communications in order to run programs which go in line with the changing world. Besides, it is the central agenda of this policy to contribute to its staffs in their career development.
	</p>
...
3.2 Policy Statement:
	...
	<p>
	It is the policy of Bizz World Communications to provide continuous high quality training and development services to improve the skills and competences of its community that will contribute to the development endeavors. In this regard, Bizz World Communications is committed itself to provide up to the standard trainings and to continually improve its training services to be in line with the different development agenda. Hence, this document is prepared to explain the basic training guidelines, procedures and responsibilities of concerned departments i.e. units within Bizz World Communications.
	</p>
</div>
<div class="col-md-12">
<h4 class="ml-md-5 mb-2">
3.3 Definitions of Training:
	...
	<ul>
		<li>
		Training is an organized procedure for developing skills, knowledge, abilities to perform a job. It will be undertaken by the Bizz World Communications staff in their field of expertise and experience and by other associate members.
		</li>
		<li>
		Training is a learning process that involves the acquisition of knowledge, sharpening of skills, concepts and rules.
		</li>
		<li>
		Training provided by Bizz World Communications can be either tailor-made.
		</li>
		<li>
		n a nutshell, training is a short term contractual agreement which makes use of Bizz World
Communication’s resources and brings extra work for Bizz World Communications staff and other stakeholders.
		</li>
	</ul>
</div>
<div class="col-md-12">
...
<p>
This training policy of Bizz World Communications therefore will have the following brief guidelines
</p>
<ul class="roman">
...
<div class="col-md-12">
	...
	<p>
	Every training program that will be provided by Bizz World Communications should be in line with Bizz World Communications training objectives and policies. To do this, the following important procedures must be incorporated.
	</p>
	<ul>
		...
		<ul class="dot">
			...
			<li>
			From the Bizz World Communication’s database, selection of Training experts should be done. An expert or group of experts will be responsible for the preparation of training module. The prepared training module will be evaluated.
			</li>
			<li>
...
<div class="col-md-12 mt-2">
	...
	<p>
	Working days at Bizz World Communications are from Monday to Saturday. Alternate Saturdays are off
...
<div class="col-md-12">
	...
	<p>
	When places of work remain open during periods of intemperate weather, employees should possible effort to report to work. Some employees may find it difficult to report for work during intemperate weather due to family responsibilities, transportation problems or road conditions but as Bizz World Communications offers transport facilities to most of the employees it is mandatory for all to must show- up to work, In other hand Bizz World Communications will make every effort to accommodate employee’s requests for leave depending on the conditions and scenarios.
	</p>
</div>
<div class="col-md-12">
	<h5 class="ml-md-5 mb-2">
...
4.4.3 Working Hours:
	...
	<ul class="roman">
		...
		<li>The normal office hours of BIZZ WORLD COMMUNICATIONS are following</li>
	</ul>
</div>
<div class="col-md-12">
<div class="imp">
...
<div class="col-md-12">
	...
	<p>
	There may be a need for employees to be on-call outside normal working hours to handle contingency or operational matters but only in exceptional cases. If the matters cannot be contend with over the telephone, BIZZ WORLD COMMUNICATIONS may require the employees to return to the workplace for emergency action and such action will be rewarded and appreciated.
	</p>
</div>
<div class="col-md-12">
...
<p>
Bizz World Communications is committed to provide a healthy workplace and environment for its employees. Some harmful effects that are caused by smoking as well as passive smoke, it is considered necessary to have a smoke-free workplace policy to work in Bizz World Communications. No-one is allowed to smoke within the office premise that includes cafeteria, kitchen, restrooms, Operational floors etc. Bizz World Communications has dedicated smoking zone for smokers. Anyone using smoker’s zone is supposed to through all cigarette buds in ash tray or dustbin placed there. Raping paper, empty packets or any other trash should not be thrown on the floor. Anyone failed to comply will be issued a warning and other actions can also be taken against them. 
</p>
</div>
<div class="col-md-12">
...
<ul>
<li>
Bizz World Communications issues salaries on second week of every month.
</li>
<li>
...
<li>
Bizz World Communications doesn't have any policy to issue salaries via check, cash or draft's across the board for any senior or junior position.
</li>
<li>
...
<li>
In-case the candidate fails to submit the account details to HR as per given time his/her services with Bizz World Communications will be suspended till HR receives the account details.
</li>
<li>
Bizz World Communications doesn't allow candidates to submit any irrelevant account details like Cousin's, Friend’s, any colleague or etc.
</li>
<li>
Only when an individual join Bizz World Communications in last 05-10 working days of the month and he/she requests then he/she can submit the account details of their immediate family member (Father, Mother, Sister and Brother only) with a written acknowledgment and copy of NIC of account holder.
</li>
<li>
...
<ul>
<li>
In order to promote the brand equity and image of Bizz World Communications, we will encourage that the employees can invite visitors, such as parents or siblings (Only blood relative or immediate family members) so that they may feel at ease that how friendly and comfortable is the working environment is in Bizz World Communications. However, in doing so the employee should pre-inform the concerned HOD, HR and Admin of the visit 1 week in advance, so that all the preliminary chores could be catered to.
</li>
<li>
...
<ul>
<li>
Bizz World Communications celebrate the birthdays for all the employees falling on their respective months with a cake cutting ceremony. And the cake would be given by the management.
</li>
<li>
...
<ul>
<li>
Office Chairs and Headsets are property of Bizz World Communications and each employee must ensure that the utility of chairs and headsets are completely accounted for by the concerned employee.
</li>
<li>
...
<p>
Bizz World Communications encourages candidates and open two-way communications between
...
<ul>
<li>
All employees are required to support the communication perspectives implemented by Bizz World Communications.
</li>
<li>
...
<li>
All employees have rights and obligations to express their views to their superiors about BIZZ WORLD COMMUNICATIONS activities and vice versa.
</li>
<li>
...
<li>
Employees should be well informed of the development and major events of Bizz World Communications, in particular those that may have an impact on their jobs and/or welfare.
</li>
</ul>
</div>
<div class="col-md-12">
...
<li>
All Employees are required to use their official email addresses under Bizz World Communications.
</li>
<li>
...
<ul>
<li>
Employees are encouraged to discuss their views of Bizz World Communications with their immediate supervisors, Head of Department, the Human Resources Department and/or the Core Team Members.
</li>
<li>
...
<p>
Bizz World Communications is committed to support every employee to reach their potential and achieve their personal goals in line with their job description, which in turn will assist the organization to achieve its objectives.
</p>
<p>
...
<p>
In Bizz World Communications, Every employee will be rewarded according to his/her performance. A strong link requires maximum effectiveness in planning, leading, and reviewing individual performance. Reward is based on merit. High performers are given priority to take up more responsible positions.
</p>
<h4 class="ml-md-5 mb-2">10.1 Appreciation Certificates:</h4>
<p>
Bizz World Communications will provide Appreciation Certificates for employees at the end of every month. Appreciation Certificate will be given on criteria of performance throughout the month or some efforts done for the organization by going an extra mile. Department heads will provide the names to HR after concerning with COO by the 01 st of every month and HR will issue the certificates to the department heads as they will distribute it among their teams.
</p>
...
<p>
Bizz World Communications has been committed to equality of opportunity and to create and sustain an environment that values and appreciate the diversity of staff and consequence of principle of equality of opportunity in which was preserved in Bizz World Communications. It is to developing and maintaining an organization where all employees from all backgrounds can thrive, and so we recognize the importance of taking a proactive stance in creating equality of opportunity.
</p>
...
<li>
Ensuring the safety and security of employees and the facilities in Bizz World Communications. Only authorized visitors are allowed in the work areas of the buildings. Restricting unauthorized visitors helps maintain safety standards, protects against theft, ensures security of equipment, protects confidential information, safeguards employee welfare, and avoids potential distractions.
</li>
</ul>
...
<li>
Must use public internet and the corporate internet should be used for Job purposes and in a manner that is consistent with Bizz World Communication’s standards of research & development conduct.
</li>
<li>
...
<li>
Must not make unauthorized copies of Bizz World Communication’s software by whatever means.
</li>
<li>
Should have responsibility for protecting and maintaining integrity of Bizz World Communication’s information and data resided on their desktop PCs.
</li>
<li>
...
<li>
Bizz World Communication’s Internet access must not be utilized to communicate information that may infringe any intellectual property rights or violate the terms of any applicable laws or regulatory requirements.
</li>
<li>
...
<li>
The Bizz World Communications provides flexible working arrangements in order to attract and retain staff members, to provide flexibility in meeting business needs, and to assist staff members in managing their work and personal responsibilities.
</li>
<li>
...
<p>
All employees have a right to work in an environment free from mistreatment intended to demean, abusive or harass. The Bizz World Communications prohibits mistreatment of its employees by supervisors, administrators, faculty, and coworkers.
</p>
<ul>
<li>
...
<p>
Bizz World Communication’s policy for the Grievance for employees should:
</p>
<ul>
<li>
...
<p>
Bizz World Communications will review all our employment practices quarterly and procedures to ensure impartiality.
</p>
</div>
<div class="col-md-12">
...
<p>
Bizz World Communications processes the personal data of individuals such as its all employees and customers. This processing is regulated by the Data security policy.
</p>
...
<li>
Bizz World Communication’s Internet access must not be utilized to communicate information that may interfere with any intellectual property rights or violation of any applicable laws or regulatory requirements.
</li>
<li>
Visiting inappropriate or unlawful web sites and chat rooms are strictly prohibited in Bizz World Communications.
</li>
<li>
Employees are not allowed to use their personal profiles for official tasks and emails. Do not use the Bizz World Communications licensed software for your personal use.
</li>
</ul>
<h4 class="ml-md-5 mb-3">13.3 Data Security:</h4>
<p>
It is the duty of data controllers, such as Bizz World Communications to comply with the data protection principles with respect to personal data. This policy describes how Bizz World Communications will assign and manage its duties in order to ensure continuing compliance and the data security rules and rights of data in particular. It is also the responsibility of an employee to keep confidential the personal data and secret information of the intended organization. If any employee is found to leak the confidential information of the organization then a serious action will be taken against him immediately.
</p>
...
<p>
Bizz World Communications will collect the relevant personal data with organizational standards of their all employees only for lawful purposes. We are responsible for privacy and personal data protection.
</p>
<ul>
<li>
...
<li>
The Personal Data will be kept confidential of Bizz World Communication’s employees except we can share your information to:
<ul class="dot">
<li>
...
<p>
This is sometimes obligatory for Bizz World Communications to monitor communications and information. This may include personal data. There may be circumstances of sharing and monitoring your personal data within the organization.
</p>
<h4 class="ml-md-5 mb-2">13.7 Penalties for Improper Usage:</h4>
<p>
Improper usage and violation of procedures and Policies by Bizz World Communications, a serious disciplinary action will be taken against the intended employee.
</p>
<p>
...
<p>
Bizz World Communications is concerned to the violation of any of its policy or rule can subject to an employee to disciplinary action. Disciplinary procedure can be taken for any failure in job, crime, physical abuse, mentally abuse, continuous unethical behavior, violation of drug alcohol, weapon possession and Insubordination.
</p>
<h4 class="ml-md-5 mb-2">14.1 Code of Conduct:</h4>
<p>
Bizz World Communications believes in professionalism, high ethical standards, integrity and honesty so the employees are crucial for any organization in maintaining and pursuing its standards of rules and regulations. The basic purpose of this Code of conduct is to set down the employees' legal obligations while under the employment of Bizz World Communications. This Code also provides guidelines to assist employees in understanding and complying with such obligations.
</p>
<ul>
<li>
...
<ul>
<li>
Bizz World Communication’s objectives for Counseling Services are to establish their employees for each and every aspect. We want to promote the psychological, emotional wellbeing, physical of our Employees and to enhance employees’ career and personal development.
</li>
<li>
...
anyone affected by the conduct, not just the individual at whom the offensive conduct is directed. We all have to give respect to every male & specially the females. Bizz World Communications want to retain the strength of the females up to 33%. The policy is made & everyone has to follow the policy. In any case of harassment proven, straight termination will be done by higher management.w
</li>
<li>
Following would be considered harassment in the premises of Bizz World Communications. (If we find anybody involve in these kinds of activities, that individual would be terminated then & there)
</li>
</ul>
...
<p>
This is an excellent act not to use foul language or swearing at all as it can help to avoid the risk of being embarrassed in workplace. Foul language is prohibited in workplaces but, it also can create harassment issues if the swearing is particularly to the gender like women. Bizz World Communications environment allow you to use the ethical language to communicate to other employees, coworkers, contractors and management to fulfill the professional requirements.
</p>
...
<p>
A warning letter can be about the correspondence that notifies the unethical behavior and violation of terms and conditions discussed in employment policy or for not meeting the targets. The purpose of warning letter is to warn an employee for continuous and regular violations of the Bizz World Communications provisions of the Workers Compensation.
</p>
<ul>
<li>
...
<p>
Suspension is a strict action by Bizz World Communications that temporarily prevention of something from continuing any job services. An employee can be suspended by the following situations:
</p>
<ul>
<li>
Bizz World Communications can suspend an employee at any time, if he/she failed to comply with the terms and conditions by the policy manual.
</li>
<li>
...
<p>
<b>Note: Bizz World Communications does not re-hire any terminated employee again</b>
</p>
<h4 class="ml-md-5 mb-3">15.1 Releases from Service:</h4>
<p>
In case of downsizing of any project or over staffed Bizz World Communications holds the right to release any employee or department head with one week notice.
</p>
...
<ul>
<li>
Bizz World Communications holds the right to terminate any employee or department head without any prior notice. But a detail reason will be brief to him/her through HR.
</li>
<li>
...
<li>
In-case if any employee won’t show-up for the exit interview, all the dues will be put on hold by Bizz World Communications. Until the exit interview process is done.
</li>
<li>
...
<ul class="roman">
<li>
Bizz World Communications will give all resigned employees for any reason an opportunity to join the team back.
</li>
<li>
...
<li>
The final word of approval on any re-hiring will be given by CEO, COO, HR Head (Bizz World Communications) only.
</li>
</ul>
